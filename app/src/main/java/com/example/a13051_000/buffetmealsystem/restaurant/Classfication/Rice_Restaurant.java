 ...
 */
public class Rice_Restaurant extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    public String[] img_text = { "米饭", "小馒头", "油泼面", "清汤面" };
    public int[] imgs = { R.drawable.z1, R.drawable.z2,
        ...
        if(ScanActivity.visible == true&& SettingsActivity.quit == false){
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent1 = new Intent(Rice_Restaurant.this, MainActivity_r.class);
                    intent1.putExtra("seat_num",ScanActivity.seat_num);
                    Rice_Restaurant.this.startActivity(intent1);
                }
            });
        }else {
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(Rice_Restaurant.this, ScanActivity.class);
                    Rice_Restaurant.this.startActivity(intent);
                }
            });
        }
    }
