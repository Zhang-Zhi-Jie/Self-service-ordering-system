 ...
 */
public class Dessert_Restaurant extends AppCompatActivity implements AdapterView.OnItemClickListener{

    private Toolbar toolbar;
    private GridView gridview;
    private List<Map<String , Object>> list;

    public String[] img_text = { "马卡龙", "蛋挞", "芒果甜心", "冰沙芒果" };
    public int[] imgs = { R.drawable.t1, R.drawable.t2,
        ...
        if(ScanActivity.visible == true&& SettingsActivity.quit == false){
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent1 = new Intent(Dessert_Restaurant.this, MainActivity_r.class);
                    intent1.putExtra("seat_num",ScanActivity.seat_num);
                    Dessert_Restaurant.this.startActivity(intent1);
                }
            });
        }else {
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(Dessert_Restaurant.this, ScanActivity.class);
                    Dessert_Restaurant.this.startActivity(intent);
                }
            });
        }
    }
