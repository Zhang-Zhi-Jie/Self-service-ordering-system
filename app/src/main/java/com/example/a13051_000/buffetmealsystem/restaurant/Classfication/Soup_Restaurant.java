 ...
 */
public class Soup_Restaurant extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    public String[] img_text = { "西红柿蛋汤", "鸡蛋玉米羹" };
    public int[] imgs = { R.drawable.s1, R.drawable.s2};
        ...
        if(ScanActivity.visible == true&& SettingsActivity.quit == false){
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent1 = new Intent(Soup_Restaurant.this, MainActivity_r.class);
                    intent1.putExtra("seat_num",ScanActivity.seat_num);
                    Soup_Restaurant.this.startActivity(intent1);
                }
            });
        }else {
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(Soup_Restaurant.this, ScanActivity.class);
                    Soup_Restaurant.this.startActivity(intent);
                }
            });
        }
    }
