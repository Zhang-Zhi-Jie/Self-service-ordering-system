...
public class Ves_Restaurant extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    public String[] img_text = { "素饼", "小青菜", "青团子", "干锅包菜" };
    public int[] imgs = { R.drawable.c1, R.drawable.c2,
        ...
        if(ScanActivity.visible == true&& SettingsActivity.quit == false){
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent1 = new Intent(Ves_Restaurant.this, MainActivity_r.class);
                    intent1.putExtra("seat_num",ScanActivity.seat_num);
                    Ves_Restaurant.this.startActivity(intent1);
                }
            });
        }else {
            ...
            button_order.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(Ves_Restaurant.this, ScanActivity.class);
                    Ves_Restaurant.this.startActivity(intent);
                }
            });
        }
    }
